...
export const WORLD_3D = {
  ...
  hazards: [
    {
      ...
      kind: "water",
      position: { x: 0, y: -3.2, z: 17 },
      size: { x: 150, y: 2, z: 164 },
      damage: 1,
      instantRespawn: true,
      active: true,
    ...
    },
    {
      ...
      kind: "void",
      position: { x: 0, y: -12, z: 17 },
      size: { x: 180, y: 2, z: 190 },
      damage: 99,
      instantRespawn: true,
      active: true,
      visual: "invisible",
  ...
  decorations: [
    ...
    { id: "sign-final", kind: "direction_sign", position: { x: 8, y: 3.8, z: 82 }, scale: { x: 1, y: 1, z: 1 }, yawRadians: 0.1, label: "太阳门 →" },
  ...
  criticalRoute: [
    ...
    { id: "route-final", position: { x: -10, y: 3, z: 78 }, hint: "越过石路后向东冲向太阳门", expectedDirection: "east" },
  ],
  goal: {
    id: "goal-sun-gate",
    name: "绒光太阳门",
    visual: "sun_gate",
    position: { x: 47, y: 5.5, z: 81 },
    size: { x: 5, y: 5, z: 3 },
